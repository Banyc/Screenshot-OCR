...
Public Class trayform
    Property IsRunning As Boolean = False  'Prevent Me from closing while there is still functions running
    ...
    Private Sub UploadToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles UploadToolStripMenuItem.Click
        ...
        If OpenFileDialog1.ShowDialog() <> DialogResult.Cancel Then  'BUG: Raise System.AccessViolationException
            Dim imgPath = OpenFileDialog1.FileName
            'Dim imgPath As String
            'imgPath = InputBox("Please write the full path for the image. JEPG ONLY")
